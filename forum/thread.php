...
<body>
    ...
    if($method== 'POST'){
        ...
        //securing comment input from XSS attack
    ...
    <div class="container" id="foot">
        ...
        <?php
            ...
            echo '<div class="media my-3">
                <img src="images/download.png" class="mr-3 mt-3" alt="user image" id="userimage">
                <div class="media-body">
                    
                    ' . $content . '
                    <p class="font-weight-bold my-0 py-0">' . $row2['username'] . ' at ' . $comment_time . '</p><hr>
                </div>
            </div>';
